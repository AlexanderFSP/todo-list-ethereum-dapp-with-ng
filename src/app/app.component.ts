...
export class AppComponent {
  ...
  public async sendEther(): Promise<void> {
    this.metamaskService.sendEther('0x3325821e0E9261c94fC8bBCE488AE4043F148D3d', '0.08');
  }

  public async inspectContrat(): Promise<void> {
    const imxContract = this.ethersContractService.createContract(
      ...
      this.metamaskService.provider
    );

    console.log(await imxContract.symbol());
  }
}
